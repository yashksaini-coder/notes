...
var AIHubSettingTab = class extends import_obsidian.PluginSettingTab {
  ...
  display() {
    ...
    containerEl.empty();
    new import_obsidian.Setting(containerEl).setName("Google AI API Key").setDesc("Enter your Google AI Studio API key.").addText(
      (text) => text.setPlaceholder("Enter your API key").setValue(this.plugin.settings.apiKey).onChange(async (value) => {
        this.plugin.settings.apiKey = value;
        await this.plugin.saveSettings();
      })
    );
    new import_obsidian.Setting(containerEl).setName("Model").setDesc("Select the AI model to use.").addText(
      (text) => text.setPlaceholder("gemini-1.5-flash").setValue(this.plugin.settings.model).onChange(async (value) => {
    ...
    editorCheckCallback: (checking, editor) => {
      ...
      (async () => {
        ...
        try {
          ...
          new import_obsidian3.Notice("AI content generated successfully!");
        } catch (error) {
...
// src/main.ts
var AIHubPlugin = class extends import_obsidian4.Plugin {
  async onload() {
    ...
    (0, import_obsidian4.setIcon)(item, "brain-circuit");
  ...
  addRibbonButton() {
    const ribbonIconEl = this.addRibbonIcon(
      ...
      async () => {
        ...
        const selectedText = editor.getSelection();
        if (!selectedText) {
          new import_obsidian4.Notice("Please select text to use as a prompt.");
          return;
        }
        ...
        try {
          ...
          editor.replaceSelection(response);
          new import_obsidian4.Notice("AI content generated successfully!");
        } catch (error) {
